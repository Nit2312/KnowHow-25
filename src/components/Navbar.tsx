...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 h-full bg-indigo-600 text-white w-64 transform transition-transform duration-200 ease-in-out z-50 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 overflow-y-auto`}>
        <div className="p-4">
